...
const eventsData: Event[] = [
  {
    id: "1",
    title: "Indie-Nacht im Objekt 5",
    description:
      "Erlebe das Beste von lokalen und internationalen Indie-Bands im legendären Objekt 5. Eine Nacht mit großartiger Musik, günstigen Getränken und guter Stimmung erwartet dich. Verpasse nicht das nächste große Ding!",
